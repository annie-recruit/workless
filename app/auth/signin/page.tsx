...
export default function SignInPage() {
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden font-galmuri11">
      {/* 픽셀 그라데이션 배경 */}
      ...
      <div className="relative z-10 max-w-md w-full space-y-12 p-8">
        <div className="text-center space-y-6">
          <div className="space-y-2">
            <h1 className="text-7xl font-bold text-white tracking-widest uppercase drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
              Workless
            </h1>
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            <div className="bg-white p-2 rounded-sm shadow-lg group-hover:scale-110 transition-transform duration-300">
