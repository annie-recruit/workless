...
export const metadata: Metadata = {
  ...
  description: 'WORKLESS는 무한 캔버스 화이트보드에서 아이디어를 자유롭게 메모하고 브레인스토밍하는 생산성 도구입니다. AI 어시스턴트가 지식 맥락을 연결해 업무 효율을 높입니다. Notion, Miro 대안 협업 도구.',
  keywords: ['메모앱', '메모 정리', '아이디어 정리', '화이트보드 앱', '무한 캔버스', '브레인스토밍 도구', '생산성 도구', '협업 도구', 'AI 메모', '지식 관리', 'PKM', '할일 관리', '업무 효율', 'Notion 대안', 'Miro 대안', '비정형 워크스페이스', '애자일'],
  alternates: {
    canonical: 'https://workless.me',
  },
  openGraph: {
