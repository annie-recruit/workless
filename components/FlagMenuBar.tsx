    ...
    return (
        <div className="shrink-0 border-b border-gray-200 bg-white px-3 py-2 flex items-center gap-2 overflow-x-auto">
            <button
                type="button"
                onClick={onAddFlag}
                className="shrink-0 px-3 py-1.5 flex items-center gap-1.5 rounded border border-gray-200 bg-white hover:bg-gray-50 transition-colors text-xs"
                title="Flag 추가"
            >
                ...
                {flags.map((flag) => {
                    ...
                    return (
                        <button
                            ...
                            className={`shrink-0 px-2 py-1 flex items-center gap-1.5 rounded border transition-colors text-xs ${isSelected
