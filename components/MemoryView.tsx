...
export default function MemoryView({ memories, clusters, onMemoryDeleted, onOpenGroups, onOpenQuery }: MemoryViewProps) {
            ...
            <div key={tag} className="space-y-3">
              ...
              <div className="space-y-2">
                {clusterMemories.map((memory) => (
                  <MemoryCard key={memory.id} memory={memory} onDelete={onMemoryDeleted} />
                ))}
              </div>
            </div>
          ))
